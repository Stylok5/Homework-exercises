...
In order to run the tests you have to first install the testing library by just running `npm i` from within the filter-map folder in the terminal.
After that, to run the tests you can simply run the command `npm run test`.
